...
| **Supabase `investments_accounts` / `investments_history`** | Deposit-fund account structure + transaction history | `storage.js` → `deposit-risk.js`, `page-home.js`, `page-finances.js` | After CSV import via `scripts/import-trading212.mjs` |
...
**Shape:** Generated by `scripts/import-trading212.mjs`. Stub until the importer is run.
