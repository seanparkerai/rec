# CHECKLIST archive — snapshot 2026-06-12

> Verbatim snapshot of the completed body of `docs/CHECKLIST.md` (Phases 0–10, V2 overhaul,
> v3.0 Outreach, v3 Live Listings L0–L6 + convergence P1–P7, data-integrity overhaul A/B,
> the P0–P10 consolidation refactor, the Model Refinement Engine banner, and the 2026-06
> organisation/fix logs). **Open items were carried forward to the live `docs/CHECKLIST.md`**
> — anything unticked below is either superseded or re-listed there. Kept for the record.
