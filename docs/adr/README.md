...
Every guard-rail / rail-change decision (plan §4, `plan/01-protocol.md`) maps to an ADR here —
the G2 mechanism from `plan/02-intake.md` §8.1. Copy `0000-template.md`, take the next free
...
- ADRs 0001–0006 were backfilled on 2026-07-03 (Phase 10.1) from decisions recorded at the time
  in `plan/03-checklist.md` and the docs — the decision dates in each header are the real ones.
