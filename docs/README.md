...
| [`PHASE0-PROBE-FINDINGS.md`](PHASE0-PROBE-FINDINGS.md) | Observed facts from the live Apify actor — which spend levers are real, which are inert, and the measured run-rate. |
