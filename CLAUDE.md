...
- `assets/js/storage.js` + `assets/js/storage/*.js` — Supabase-backed storage layer (see §17). `storage.js` is a re-export shim (P8) over `storage/{core,user-state,listings,outreach,refinement}.js`. **Extend, do not rewrite.**
