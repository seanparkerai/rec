...
0. **Supabase freshness check — only if this session edits data, schema, or user-state** (skip entirely
   ...
   blocking ceremony:
   - `mcp__supabase__list_tables` — confirm the 22 curated tables exist with RLS enabled (inventory in
