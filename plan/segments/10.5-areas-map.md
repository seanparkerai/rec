...
- **Queued in `docs/CHECKLIST.md` (not yet done):** MapLibre GL v5 + PMTiles map upgrade (8B); Areas compare drawer; `base.css` component split (8A leftover); geocode-areas precise coords (needs-network).
