...
- [ ] 3.3b Shell bootstrap extraction: theme / nav-drawer / header-user wiring out of `components.js` into `assets/js/shell/` modules (bootstrapper stays thin, import path unchanged); page tests for the extracted wiring.
