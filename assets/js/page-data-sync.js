...
import { jsonEq, diffData, formatTs, flattenToRows } from './data-sync/diff.js';
...
// sortJson / jsonEq / diffData / formatTs now live in ./data-sync/diff.js (imported above).
...
// flattenToRows now lives in ./data-sync/diff.js (imported above).
...
on(byId('btn-add-member'), 'click', () => {
  ...
  row.innerHTML = `
    <div>
      ...
      <input type="text" placeholder="e.g. Sam" class="member-name" />
    </div>
    <div>
