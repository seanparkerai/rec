...
const { register: registerOutreachTemplates } = await import('../tests/contract/outreach-templates.test.js');
...
const { register: registerVerifyAreaCoords } = await import('../tests/unit/verify-area-coords.test.js');
...
const { register: registerResolveAreas } = await import('../tests/unit/resolve-areas.test.js');
const { register: registerAreaMatch } = await import('../tests/unit/area-match.test.js');
const { register: registerSetupWizard } = await import('../tests/unit/setup-wizard.test.js');
...
const { register: registerDomUtils }                 = await import('../tests/unit/dom-utils.test.js');
const { register: registerCharacterizationHome }     = await import('../tests/characterization/characterization-home.test.js');
const { register: registerCharacterizationFinances } = await import('../tests/characterization/characterization-finances.test.js');
const { register: registerCharacterizationOutreach } = await import('../tests/characterization/characterization-outreach.test.js');
const { register: registerCharacterizationStorage }  = await import('../tests/characterization/characterization-storage.test.js');
...
const { register: registerImportLayer } = await import('../tests/contract/import-layer.test.js');
const { register: registerAreasIndexSync } = await import('../tests/contract/areas-index-sync.test.js');
const { register: registerAreasDbRepoParity } = await import('../tests/contract/areas-db-repo-parity.test.js');
...
const { register: registerCriteriaForm } = await import('../tests/unit/criteria-form.test.js');
const { register: registerAssetLinks } = await import('../tests/contract/asset-links.test.js');
const { register: registerJourneyData } = await import('../tests/contract/journey-data.test.js');
const { register: registerJourneyProgress } = await import('../tests/unit/journey-progress.test.js');
...
const { register: registerAreaRef } = await import('../tests/unit/area-ref.test.js');
const { register: registerAreaEnrich } = await import('../tests/unit/area-enrich.test.js');
const { register: registerDocsConsistency } = await import('../tests/contract/docs-consistency.test.js');
const { register: registerAskTools } = await import('../tests/contract/ask-tools.test.js');
const { register: registerAskStorage } = await import('../tests/contract/ask-storage.test.js');
const { register: registerProfileSchema } = await import('../tests/contract/profile-schema.test.js');
const { register: registerSavingsEdit } = await import('../tests/unit/savings-edit.test.js');
const { register: registerLiveFeedRuns } = await import('../tests/unit/live-feed-runs.test.js');
const { register: registerLiveFeedStats } = await import('../tests/unit/live-feed-stats.test.js');
const { register: registerRlsCheck } = await import('../tests/contract/rls-check.test.js');
...
await registerRlsCheck({ test, assert, assertEqual });
