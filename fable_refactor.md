...
**Phase 2…N — Per-segment overhaul** *(sequence set during intake; tests precede code per §5.3)*
- [ ] _Segment, sub-phases, guard-rail decisions, owner, status — fill during re-plan._
